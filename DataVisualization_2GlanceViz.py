...
# gv.plot_NG_byTwoFeatures(colName_feat1='MELT_TEMP', colName_feat2='MELT_WEIGHT',period='ALL', drawLine_at=(None, None), y_min=(None, None), load_dfORG=False)

# 특정 날짜 NG 조회
gv.plot_NG_byTwoFeatures(colName_feat1='MELT_WEIGHT', colName_feat2='MELT_TEMP',period='3/10', drawLine_at=('ax1', 250), y_min=(None, None), load_dfORG=False)
gv.plot_NG_byTwoFeatures(colName_feat1='MELT_WEIGHT', colName_feat2='MELT_TEMP',period='3/22', drawLine_at=('ax1', 250), y_min=(None, None), load_dfORG=False)
gv.plot_NG_byTwoFeatures(colName_feat1='MELT_WEIGHT', colName_feat2='MELT_TEMP',period='4/4', drawLine_at=('ax1', 250), y_min=(None, None), load_dfORG=False)
gv.plot_NG_byTwoFeatures(colName_feat1='MELT_WEIGHT', colName_feat2='MELT_TEMP',period='4/15', drawLine_at=('ax1', 250), y_min=(None, None), load_dfORG=False)